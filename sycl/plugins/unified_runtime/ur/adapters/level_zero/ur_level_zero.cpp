...
UR_APIEXPORT ur_result_t UR_APICALL urPlatformGet(
  ...
  PI_ASSERT(NumPlatforms, UR_RESULT_ERROR_INVALID_VALUE);
  ...
  if (ZeResult == ZE_RESULT_ERROR_UNINITIALIZED) {
    PI_ASSERT(NumPlatforms != 0, UR_RESULT_ERROR_INVALID_VALUE);
    *NumPlatforms = 0;
    return UR_RESULT_SUCCESS;
  }
...
UR_APIEXPORT ur_result_t UR_APICALL urPlatformGetInfo(
  ...
  UrReturnHelper ReturnValue(pSizeRet, ParamValue);
...
UR_APIEXPORT ur_result_t UR_APICALL urDeviceGetInfo(
  ...
  // case UR_DEVICE_INFO_OPENCL_C_VERSION:
  //   return ReturnValue("");
...
UR_APIEXPORT ur_result_t UR_APICALL urDevicePartition(
  ...
  PI_ASSERT(NumDevices, UR_RESULT_ERROR_INVALID_VALUE);
  PI_ASSERT(Device, UR_RESULT_ERROR_INVALID_NULL_HANDLE);
