...
struct ur_command_list_manager : ur_object, public ur_queue_t_ {
  ...
  /************ Methods specific to each queue mode *************/
  ur_result_t queueGetInfo(ur_queue_info_t, size_t, void *, size_t *) override {
    return UR_RESULT_ERROR_UNSUPPORTED_FEATURE;
  };
  ur_result_t queueGetNativeHandle(ur_queue_native_desc_t *,
  ...
  ur_result_t enqueueEventsWait(uint32_t, const ur_event_handle_t *,
                                ur_event_handle_t *) override {
    return UR_RESULT_ERROR_UNSUPPORTED_FEATURE;
  };
  ur_result_t enqueueEventsWaitWithBarrier(uint32_t, const ur_event_handle_t *,
                                           ur_event_handle_t *) override {
    return UR_RESULT_ERROR_UNSUPPORTED_FEATURE;
  };
  ur_result_t
  ...
  /************ Helper methods *************/
  ur_result_t enqueueBarrier(uint32_t numEventsInWaitList,
